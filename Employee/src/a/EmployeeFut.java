...
public class EmployeeFut {
	public static void main(String [] args) {
		...
		Employee[] alkArray= new Employee[alkNumber];
		
		for(int i=1; i<alkArray.length;i++) {
			...
			alkArray[i]=new Employee(name, age, payment);
		}
		sc.close();
		...
		System.out.println("");
		System.out.println("Azon alkalmazottak, akiknek az átlagnál több éve van hátra a nyugdijig:");
		int sum=0;
		double average=0;
		for(Employee a:alkArray) {
		...
		System.out.println("");
		System.out.println("Alkalmazottak a nyugdijig hátralévõ idõ alapján növekvõ sorrendben:");
		
		Employee[] sortedArray=new Employee[alkArray.length];
		Employee temp;
